...
class BigTimeAPI:
    ...
    # def get_picklist_all_tasks_by_project(self, project_id: str) -> Picklist:
    #     result = self._rest_adapter.get(
    #         endpoint=f"picklist/AllTasksByProject/{project_id}/"
    #     )
    ...
    # ) -> Result:
    #     result = self._rest_adapter.get(
    #         endpoint=f"time/byproject/{project_id}/",
    #         params={"StartDt": start_date, "EndDt": end_date, "View": "Detailed"},
    #     )
